...
struct ImDrawCmd
{
    ...
    bool               UseManagedTexture;
    ImManagedTextureID ManagedTextureId;
...
struct ImFontAtlas
{
    ...
    void                        SetManagedTexID(ImManagedTextureID id) { ManagedTexID = id; }
    ...
    ImManagedTextureID          ManagedTexID;
